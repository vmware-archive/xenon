...
public class SubscriptionDemo {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        host.startFactory(MySubscriptionService.class, MySubscriptionService::createFactory);
        ...
        Operation createSub = Operation.createPost(
                UriUtils.buildUri(host, MySubscriptionService.FACTORY_LINK))
