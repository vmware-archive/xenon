...
export class SeedConfig {
     ...
     * @type {number}
     */
    COVERAGE_PORT = argv['coverage-port'] || 5004;
    ...
    */
     ...
     * @type {string}
     */
    APP_BASE = argv['base'] || (this.ENV === ENVIRONMENTS.DEVELOPMENT ? '/' : '/core/ui/default/');
    ...
    /**
     * The folder for the built assets.
     * @type {string}
     */
    ...
    PLUGIN_CONFIGS: any = {
         ...
         */
        'gulp-sass': {
            includePaths: ['./node_modules/', './src/client/css']
        },
