...
class NettyWebSocketRequestHandler extends SimpleChannelInboundHandler<Object> {
     ...
     * {@link com.vmware.dcp.common.Operation.SerializedOperation} in case when this frame is an operation to be
     * complete by a client service and first line is HTTP_METHOD SERVICE_URI. Method name corresponds to
     * {@link com.vmware.dcp.common.Operation.SerializedOperation#action} specified in the serialized operation.
