...
/**
 * Copied as is from https://raw.githubusercontent.com/yonik/java_util/master/src/util/hash/MurmurHash3.java
 * As the GIT project indicates the code is public domain and meant to be copied (there are no build artifacts)
 *
